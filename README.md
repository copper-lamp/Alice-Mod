# Alice Mod — Minecraft AI Agent 框架
...
Alice Mod 是一个通用的 Minecraft AI Agent 框架，通过大语言模型（LLM）驱动游戏内假人，实现从感知、决策到执行的完整闭环。
...
|     V4    |  执行 | LLM 调度层 v1 (FCP)         | 寻路 + move\_to + 骑乘 | 寻路 + move\_to + 骑乘 | 假人可自主移动       |

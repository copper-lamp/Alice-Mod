...
> 本文档为**代码实现阶段**输出。2026-07-23 多版本实测发现，版本坐标和构建工具链已修正，但 Minecraft 1.21.8/26.x 的源码 API 迁移尚未完成，当前不可宣称 10 版本全部可发布。
...
| ⚠️ 1.21.5 | 21 | 0.16.10 | 0.120.0+1.21.5 | 1.21.5-1.4.169+v250325 | 1.11-SNAPSHOT |
| ⚠️ 1.21.6 | 21 | 0.16.14 | 0.128.1+1.21.6 | 1.21.6-1.4.176+v250617 | 1.11-SNAPSHOT |
| ⚠️ 1.21.7 | 21 | 0.16.14 | 0.129.0+1.21.7 | 1.21.7-1.4.177+v250630 | 1.11-SNAPSHOT |
| ❌ 1.21.8 | 21 | 0.16.14 | 0.130.0+1.21.8 | 1.21.7-1.4.177+v250630（无正式 1.21.8 构件） | 1.11-SNAPSHOT |
| ⚠️ 1.21.9 | 21 | 0.16.14 | 0.135.0+1.21.9 | 1.21.9-1.4.185+v250930 | 1.11-SNAPSHOT |
| ⚠️ 1.21.10 | 21 | 0.16.14 | 0.136.0+1.21.10 | 1.21.10-1.4.186+v251009 | 1.11-SNAPSHOT |
| ⚠️ 1.21.11 | 21 | 0.16.14 | 0.137.0+1.21.11 | 1.21.11-1.4.194+v260107 | 1.11-SNAPSHOT |
| ❌ 26.1 | 25 | 0.18.4 | 0.144.3+26.1 | 26.1+v260401 | 1.15-SNAPSHOT |
...
| 某 MC 版本构建失败 | versions.json 版本号错误或源码 API 尚未迁移 | 检查对应版本的 Fabric API / Carpet 版本；必要时先将该版本移出 release.yml 白名单，优先发布已成功版本 |

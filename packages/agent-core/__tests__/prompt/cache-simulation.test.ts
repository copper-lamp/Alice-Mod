...
const allTools: ToolSchema[] = [
  ...
  { name: 'memory_recall', description: '回忆记忆', category: ToolCategory.Memory, parameters: { query: { type: 'string', description: '查询', required: true } } },
  { name: 'memory_store', description: '存储记忆', category: ToolCategory.Memory, parameters: { key: { type: 'string', description: '键', required: true }, value: { type: 'string', description: '值', required: true } } },
